...
describe("Path Enviar Path", () => {
  beforeEach(() => {
    ...
    (apiUserService.ApiCallUser as ReturnType<typeof vi.fn>).mockResolvedValue({
      id: "MOCKED_ID",
      documentId: "123456789",
      idType: "CC",
      name: "Jhon Doe",
  ...
  test("validar horas totales", async () => {

    const horasTotalesElement = await screen.findByText(
      /Horas Totales: 32/i
    );
    expect(horasTotalesElement).toBeDefined();
  });
});
